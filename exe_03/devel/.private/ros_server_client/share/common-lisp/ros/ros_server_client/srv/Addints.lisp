...
(cl:in-package ros_server_client-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Addints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_server_client-srv:<Addints-request> is deprecated: use ros_server_client-srv:Addints-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_server_client-srv:num1-val is deprecated.  Use ros_server_client-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_server_client-srv:num2-val is deprecated.  Use ros_server_client-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Addints-request>)))
  ...
  "ros_server_client/AddintsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Addints-request)))
  "Returns string type for a service object of type 'Addints-request"
  "ros_server_client/AddintsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Addints-request>)))
  ...
  (cl:format cl:nil "#client makes request to server~%int32 num1 ~%int32 num2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Addints-request)))
  "Returns full string definition for message of type 'Addints-request"
  (cl:format cl:nil "#client makes request to server~%int32 num1 ~%int32 num2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Addints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_server_client-srv:<Addints-response> is deprecated: use ros_server_client-srv:Addints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <Addints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_server_client-srv:sum-val is deprecated.  Use ros_server_client-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Addints-response>)))
  ...
  "ros_server_client/AddintsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Addints-response)))
  "Returns string type for a service object of type 'Addints-response"
  "ros_server_client/AddintsResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Addints-response>)))
  ...
  (cl:format cl:nil "#server responses to client~%int32 sum~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Addints-response)))
  "Returns full string definition for message of type 'Addints-response"
  (cl:format cl:nil "#server responses to client~%int32 sum~%~%~%"))
