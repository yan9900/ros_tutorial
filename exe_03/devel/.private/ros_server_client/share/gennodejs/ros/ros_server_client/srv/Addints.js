...
// (in-package ros_server_client.srv)
...
class AddintsRequest {
  ...
  static datatype() {
    ...
    return 'ros_server_client/AddintsRequest';
  }
...
class AddintsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_server_client/AddintsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ros_server_client/Addints'; }
};
